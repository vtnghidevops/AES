...
namespace AES_GUI
{
    public partial class ENCRYPT : Form
    {
        ...
        public static extern void PerformEncryption(string mode, string keyformat, string keyFile, string ivFile, string inputFile, string outputFile);
        public ENCRYPT()
        {
            InitializeComponent();
        }
        ...
        private void btn_genKey_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string inputFile = tb_pathPlaintext.Text;
                string outputFile = tb_pathCipher.Text;
                ...
                try
                {
                    ...
                    MessageBox.Show($"Encrypt generation completed in {stopwatch.ElapsedMilliseconds} ms.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_selectPathPlaintext_Click(object sender, EventArgs e)
        {
            ...
            {
                string selectedFilePath = openFileDialog.FileName;
                tb_pathPlaintext.Text = selectedFilePath; // Hiển thị đường dẫn file đã chọn vào tb_pathIV
            }
        }
        ...
        private void btn_selectPathCipher_Click(object sender, EventArgs e)
        {
            ...
            {
                string selectedFilePath = openFileDialog.FileName;
                tb_pathCipher.Text = selectedFilePath; // Hiển thị đường dẫn file đã chọn vào tb_pathIV
            }
        }
    }
}
